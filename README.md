# Git Repository Activity Dashboard (Streamlit Project)

Through the streamlit dashboard it's possible to explore the following metrics on a target git repository:
